...
// void main_blocks_diagonal_multiply(int n, int m, int l, double *a, double *b, double *d, double
// *c); void main_blocks_multiply(int n, int m, int l, double *a, double *b, double *c);
...
// double *b); void cpy_matrix_block_to_block(double *a, int row, int column, int matrix_size, int
// n, int m, double *b);
